...
namespace FischBot.Modules
{
    ...
    public class GameModule : FischBotModuleBase<SocketCommandContext>
    {
        ...
        [Command("roulette")]
        [Summary("Spins the roulette wheel and gives out a reward or punishment.")]
        public async Task SpinTheRouletteWheel()
        {
            var embedBuilder = new EmbedBuilder()
            {
                Color = Color.DarkGrey,
                Title = "That's a bold move cotton, let's see how it pays out for you"
            };
